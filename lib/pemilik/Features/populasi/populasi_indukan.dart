...
class populasi_indukan extends StatefulWidget {
  const populasi_indukan({ Key? key }) : super(key: key);

  @override
  State<populasi_indukan> createState() => _populasi_indukanState();
}

class _populasi_indukanState extends State<populasi_indukan> {
...
Stream<List<Data>> readData() => FirebaseFirestore.instance.collection("populasi_hewan_ternak").where('JenisTernak', isEqualTo: "Indukan")
