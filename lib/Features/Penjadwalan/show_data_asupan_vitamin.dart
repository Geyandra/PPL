...
class _show_data_asupan_vitaminState extends State<show_data_asupan_vitamin> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {showDialog(context: context, builder: (context) => SimpleDialog(
          ...
          children: [
            ...
            RoundedInputField(screenWidth: screenWidth, screenHeight: screenHeight, hinText: "Hari Asupan Vitamin", icon: Icons.view_day, ),
            RoundedInputField(screenWidth: screenWidth, screenHeight: screenHeight, hinText: "Tanggal Asupan Vitamin", icon: Icons.date_range_outlined, ),
      ...
      appBar: AppBar(
        title: Text("Jadwal Asupan Vitamin Hewan Ternak")
      ),
        ...
        SfDataGrid(
          ...
          columns: [
            GridTextColumn(
              ...
              GridTextColumn(
                // width: screenWidth/6,
              columnName: 'Hari Asupan Vitamin',
              label: Container(
                // color: Colors.blue,
              ...
              GridTextColumn(
                // width: screenWidth/6,
              columnName: 'Tanggal Asupan Vitamin',
              label: Container(
                // padding: EdgeInsets.symmetric(horizontal: 1),
                alignment: Alignment.center,
                child: Text(
                  'Tanggal Asupan Vitamin',
                  // overflow: TextOverflow.ellipsis,
                ),
              )),
              GridTextColumn(
...
class DataSource extends DataGridSource {
  DataSource(List<Data>datas){
    ...
    .map<DataGridRow>((dataGridRow) => DataGridRow(cells: [
      ...
      DataGridCell<String>(columnName: "Hari Asupan Vitamin", value: dataGridRow.HariAsupanVitamin),
      DataGridCell<String>(columnName: "Tanggal Asupan Vitamin", value: dataGridRow.TanggalAsupanVitamin),
