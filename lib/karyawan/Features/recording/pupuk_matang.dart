...
class pupuk_matang extends StatefulWidget {
  const pupuk_matang({Key? key}) : super(key: key);

  @override
  State<pupuk_matang> createState() => _pupuk_matangState();
}

class _pupuk_matangState extends State<pupuk_matang> {
...
Stream<List<Data>> readData() => FirebaseFirestore.instance
    ...
    .where('JenisProduk', isEqualTo: "Pupuk Matang")
    .snapshots()
    .map((snapshots) =>
